...
| [aws_cloudwatch_log_metric_filter.s3_creation_deletion](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_log_metric_filter) | resource |
...
| [aws_cloudwatch_metric_alarm.s3_creation_deletion](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_metric_alarm) | resource |
...
| <a name="input_s3_creation_deletion"></a> [s3\_creation\_deletion](#input\_s3\_creation\_deletion) | A CloudWatch Alarm that triggers when an S3 Bucket is created or deleted. | `bool` | `true` | no |
