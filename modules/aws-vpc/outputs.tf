...
output "public_azs" {
  description = "A list of public availability zones specified as argument to this module"
  value       = var.public_azs
}

output "private_azs" {
  description = "A list of private availability zones specified as argument to this module"
